...
export async function getStaticPaths() {
  return {
    paths: [
      ...
      { params: { pid: "mejores-lugares-academias-baile-colombia-aprender-salsa-bachata-mas" }, locale: "es-CO" },
      { params: { pid: "mejores-lugares-academias-baile-colombia-aprender-salsa-bachata-mas" }, locale: "en-US" },
