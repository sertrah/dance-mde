...
export default function EventsPage(props: any) {
  return (
    <>
      <Head>
        <title>Events</title>
        <meta name="description" content="Descubrir los eventos de baile, socailes y talleres en Medellín." />
        <meta name='keywords' content='Eventos de Baile Medellín, Baile Social en Medellín, Conciertos y Baile en Medellín' />
