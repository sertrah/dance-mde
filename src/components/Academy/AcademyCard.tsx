    ...
    <section className={style.academy}>
      ...
      <div className={style.academy_detail}>
        ...
        <div className={style.academy_social_media}>
          <Link href={instagramLinkTo.url} className={style.academy_link} target="_blank">
            Instagram
            <InstagramIcon />
          </Link>
          <Link  href={`https://wa.me/57${whatsAppNumber}?text=Hola%2C%20vi%20tu%20academia%20desde%20el%20portal%20web%20dance-mde.%20Me%20gustar%C3%ADa%20saber%20m%C3%A1s%21`} target="_blank" className={style.academy_link}>
            Whatsapp
            <WhatsAppIcon />
          </Link>
        </div>
